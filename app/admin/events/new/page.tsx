  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '720px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--text-primary)' }}>Nouvel événement</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginTop: '0.25rem' }}>Créer un nouvel événement</p>
        </div>
      </div>
      ...
      >
        <div>
          ...
          <input
            name="title" required placeholder="Nom de l'événement"
            style={{
        ...
        <div>
          ...
          <textarea
            name="description" required rows={4} placeholder="Description de l'événement..."
            style={{
              width: '100%', padding: '0.75rem 1rem',
              background: 'var(--bg-elevated)', border: '1px solid var(--border-mid)',
              borderRadius: 'var(--radius-md)', color: 'var(--text-primary)',
        ...
        <div>
          ...
          <input
            name="location" required placeholder="Ex: Centre de conférences, Paris"
            style={{
              width: '100%', padding: '0.75rem 1rem',
              background: 'var(--bg-elevated)', border: '1px solid var(--border-mid)',
              borderRadius: 'var(--radius-md)', color: 'var(--text-primary)',
