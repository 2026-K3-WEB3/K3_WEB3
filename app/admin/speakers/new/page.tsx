  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '640px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--text-primary)' }}>Nouvel intervenant</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginTop: '0.25rem' }}>Ajouter un intervenant à la plateforme</p>
        </div>
      </div>
      ...
      >
        <div>
          ...
          <input
            name="name" required placeholder="Prénom Nom"
            style={{
        ...
        <div>
          ...
          <textarea
            name="bio" rows={4} placeholder="Description de l'intervenant..."
            style={{
              width: '100%', padding: '0.75rem 1rem',
              background: 'var(--bg-elevated)', border: '1px solid var(--border-mid)',
              borderRadius: 'var(--radius-md)', color: 'var(--text-primary)',
        ...
        <div>
          ...
          <input
            name="photo" type="url" placeholder="https://exemple.com/photo.jpg"
            style={{
              width: '100%', padding: '0.75rem 1rem',
              background: 'var(--bg-elevated)', border: '1px solid var(--border-mid)',
              borderRadius: 'var(--radius-md)', color: 'var(--text-primary)',
